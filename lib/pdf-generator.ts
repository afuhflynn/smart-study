...
export async function generateUserDataPDF(userId: string): Promise<Buffer> {
  ...
  doc.text("ChapterFlux Data Export", margin, yPosition);
  yPosition += 15;
  ...
  doc.setFontSize(10);
  doc.setFont("helvetica", "normal");
  doc.text("This data export was generated by ChapterFlux.", margin, 20);
  doc.text(`Generated on: ${new Date().toLocaleDateString()}`, margin, 30);
  doc.text(
    "For questions about your data, contact support@chapterflux.com",
    margin,
    40
  );
